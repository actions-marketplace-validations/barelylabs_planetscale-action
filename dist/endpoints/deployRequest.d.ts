...
export declare function getDeployRequest(props: BranchActionProps & {
...
export declare function getAllDeployRequests(props: BranchActionProps): Promise<{
    created_at?: string | null | undefined;
    updated_at?: string | null | undefined;
    deployed_at?: string | null | undefined;
    number: number;
...
export declare function createDeployRequest(props: BranchActionProps & {
    branchName: string;
...
export declare function queueDeployRequest(props: BranchActionProps & {
    deployRequestNumber: number;
}): Promise<number>;
